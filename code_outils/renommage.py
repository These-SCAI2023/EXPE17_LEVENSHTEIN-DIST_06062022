...
def archeo_nommage(version, vers_ren):
    ##Kraken
    ##Kraken fr
    if version=="Kraken-base.txt" or version=="Kraken-base" or version=="kraken-base" or version=="kraken" or version=="Kraken" :
        version=re.sub("Kraken-base.txt|Kraken-base|kraken-base|kraken|Kraken",f"Kraken -- {vers_ren}",version)
...
def nommage(version):
    ...
    if version == "Kraken-base.txt" or version == "Kraken-base" or version == "kraken-base" or version == "Krakenbase" or version == "krakenbase" or version == "kraken" or version == "Kraken":
        version = re.sub("Kraken-base.txt|Kraken-base|kraken-base|Krakenbase|krakenbase|kraken|Kraken", f"Kraken", version)
        # print("Version : ", version)
